...
# Closing Comments  {background-color="#3c3c44" background-image=https://allisonhorst.github.io/palmerpenguins/logo.png background-size="30%" background-opacity="0.4" background-position="80% 20%"}
...
## Function Conflicts {.slide-only .unlisted}
