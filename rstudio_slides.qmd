...
# RStudio {background-color="#3c3c44" background-image="assets/RStudio_icon.png" background-size="40%" background-opacity="0.5" background-position='80% 50%'}
...
## RStudio: The Script Window {.slide-only .unlisted}
...
## Creating Vectors {.slide-only .unlisted}
